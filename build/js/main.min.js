...
},{"./accordions":1}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.marker = exports.map = void 0;
...
exports.map = map;
_leaflet.default.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
  maxZoom: 19,
  attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
}).addTo(map);
var leafletIcon = _leaflet.default.icon({
  iconUrl: './img/svg/map-pin.svg',
  className: 'company-information__map-icon'
});
var marker = _leaflet.default.marker([55.0290694, 82.9278779], {
  icon: leafletIcon
}).addTo(map);
exports.marker = marker;

},{"../vendor/leaflet":25}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.openCloseSubMenu = exports.openCloseMenu = void 0;
var _scrollLock = require("../utils/scroll-lock");
var navMain = document.querySelector('.main-nav');
var navToggle = document.querySelector('.main-nav__toggle');
var mainNav = document.querySelector('.main-nav__menu-wrapper');
var listItems = document.querySelectorAll('.main-nav__menu-item');
var subMenuButtons = document.querySelectorAll('.submenu__button');
var subMenuItems = document.querySelectorAll('.submenu__list-item');
...
document.addEventListener('click', function (evt) {
  var click = evt.composedPath().includes(mainNav);
  if (!click) {
...
var openCloseSubMenu = function openCloseSubMenu() {
...
exports.openCloseSubMenu = openCloseSubMenu;
subMenuItems.forEach(function (subMenuItem) {
  return subMenuItem.addEventListener('click', function (evt) {
    if (evt) {
      if (navMain.classList.contains('main-nav--opened')) {
        navMain.classList.add('main-nav--closed');
        navMain.classList.remove('main-nav--opened');
...
},{"../utils/scroll-lock":24}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setNewsButton = void 0;
var newsButtons = document.querySelectorAll('.news__button');
var newsButtonsWrapper = document.querySelector('.news__buttons-wrapper');
var setUpNewsButton = function setUpNewsButton(evt) {
  var activeButton = evt.target.closest('.news__button');
  if (activeButton.classList.contains('news__button--active')) {
    return;
  }
  newsButtons.forEach(function (button) {
    return button.classList.remove('news__button--active');
  });
  activeButton.classList.add('news__button--active');
};
var setNewsButton = function setNewsButton() {
  newsButtonsWrapper.addEventListener('click', setUpNewsButton);
};
exports.setNewsButton = setNewsButton;
...
var _scrollLock = require("../utils/scroll-lock");
var companyModal = document.querySelector('.company-modal');
var buttonClose = document.querySelector('.company-modal__button-close');
var buttonOpen = document.querySelector('.company__button');
window.scrollLock = new _scrollLock.ScrollLock();
var initModal = function initModal() {
  if (document.body.contains(document.querySelector('.company-modal'))) {
    ...
    companyModal.addEventListener('click', function (evt) {
...
},{"../utils/scroll-lock":24}],7:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setReviewsSwiper = exports.setProgramsSwiper = exports.setNewsSwiper = exports.setHeroSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var setHeroSwiper = function setHeroSwiper() {
  if (document.body.contains(document.querySelector('.hero__swiper-wrapper'))) {
    // eslint-disable-next-line no-new
    new _swiper.default('.hero__swiper-wrapper', {
      // Optional parameters
      loop: true,
...
exports.setHeroSwiper = setHeroSwiper;
var setProgramsSwiper = function setProgramsSwiper() {
  if (document.body.contains(document.querySelector('.programs__swiper-wrapper'))) {
    // eslint-disable-next-line no-new
    new _swiper.default('.programs__swiper-wrapper', {
      // Optional parameters
      loop: false,
      breakpoints: {
        320: {
...
exports.setProgramsSwiper = setProgramsSwiper;
var setReviewsSwiper = function setReviewsSwiper() {
  if (document.body.contains(document.querySelector('.reviews__swiper-wrapper'))) {
    // eslint-disable-next-line no-new
    new _swiper.default('.reviews__swiper-wrapper', {
      loop: false,
      breakpoints: {
        320: {
          slidesPerView: 1,
...
exports.setReviewsSwiper = setReviewsSwiper;
var setNewsSwiper = function setNewsSwiper() {
  if (document.body.contains(document.querySelector('.news__swiper-wrapper'))) {
    // eslint-disable-next-line no-new
    new _swiper.default('.news__swiper-wrapper', {
      loop: false,
      breakpoints: {
        320: {
          slidesPerView: 1,
...
exports.setNewsSwiper = setNewsSwiper;

},{"../vendor/swiper":26}],8:[function(require,module,exports){
"use strict";
...
var _pageSwiper = require("./blocks/page-swiper");
var _menu = require("./blocks/menu");
var _openModal = require("./blocks/open-modal");
var _customSelect = require("./modules/form-validate/custom-select");
var _initAccordion = require("./blocks/init-accordion");
var _map = require("./blocks/map");
var _newsSorter = require("./blocks/news-sorter");
window.addEventListener('DOMContentLoaded', function () {
  (0, _iosVhFix.iosVhFix)();
  (0, _pageSwiper.setHeroSwiper)();
  (0, _pageSwiper.setProgramsSwiper)();
  (0, _pageSwiper.setReviewsSwiper)();
  (0, _pageSwiper.setNewsSwiper)();
  (0, _menu.openCloseMenu)();
  (0, _menu.openCloseSubMenu)();
  (0, _openModal.initModal)();
  (0, _initAccordion.initAccordions)();
  // eslint-disable-next-line no-unused-expressions
  _map.marker;
  // eslint-disable-next-line no-unused-expressions
  _map.map;
  (0, _newsSorter.setNewsButton)();
...
},{"./blocks/init-accordion":2,"./blocks/map":3,"./blocks/menu":4,"./blocks/news-sorter":5,"./blocks/open-modal":6,"./blocks/page-swiper":7,"./modules/form-validate/custom-select":11,"./modules/form-validate/form":12,"./modules/modals/init-modals":19,"./utils/ios-vh-fix":23}],9:[function(require,module,exports){
"use strict";
...
},{"./create-select-markup":10,"./utils":17}],12:[function(require,module,exports){
"use strict";
...
},{"./callback":9,"./init-phone-input":13,"./validator":18}],13:[function(require,module,exports){
"use strict";
...
},{"./matrix":14,"./regular-expression":15,"./render-message":16}],19:[function(require,module,exports){
"use strict";
...
},{"./modals":20}],20:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":21,"../../utils/scroll-lock":24}],21:[function(require,module,exports){
"use strict";
